\begin{frame}
\frametitle{Dim. 1: Involved vs Informational production}
\framesubtitle{\citep{biber_variation_1988, berber_sardinha_multi-dimensional_2019, berber_sardinha_multi-dimensional_2014}}
...
\end{axis}
\end{tikzpicture}
%    \caption{($\chi^2$=34.6656, \textit{p}<.0001, $\gamma$=-.7013)}
%	\caption{Loadings Dimension 1}
%    \label{means:f1}
%\end{figure}
